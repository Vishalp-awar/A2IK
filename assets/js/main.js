...
// });
// function readMore() {
//   var expandInfo = document.getElementById("more-info-js-alt");
//   var mainHeadings = document.getElementById("main-headings-js-alt");
//   var Imagealt= document.getElementById("image-wrapper-js-alt")
//   if (expandInfo.style.height === "350px") {
//     mainHeadings.style.transform = "scale(1)";
//     Imagealt.style.transform="scale(1)";
//     expandInfo.style.height = "0";
//   } else {
//     mainHeadings.style.transform = "scale(0.7)";
//     expandInfo.style.height = "350px";
//     Imagealt.style.transform = "scale(0.7)";
//   }
// }
document.querySelectorAll('.accordion-list a').forEach((accordion) => {
